...
${!same ? `
  ...
  Кількість банок <em>(також визначається замовником)</em> для кожного різновиду товару під час комбінування<br>
  асортименту може <u>відрізнятись одна від одної</u>, але їхня загальна кількість має відповідати<br>
  <u>єдиному «розмірові партії», встановленому для всього замовлення.</u>.<br>  
