...
const BULK = {
  ...
  ${!same ? `
    ...
    Вона має бути <u>однаковою</u> для кожної позиції у кошику <em>(кожному різновіду товару)</em>.<br>
    Кількість банок <em>(також визначається замовником)</em> у кожному різновіду товару <br>
    може <u>відрізнятись</u>, а їх сума <u>має дорівнювати «розміру партії»</u>.<br>
    → <strong>Тому, будь ласка:</strong><br>
    <ul style="margin-top: 4px;">
      <li>Повністю очистіть кошик</li>
      <li>Формуйте асортимент кошику, дотримуючись вимог про «розмір партії»</li>
    </ul>
  ` : ''}
