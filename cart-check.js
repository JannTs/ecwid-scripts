...
const BULK = {
  ...
  ${!same ? `
    <strong>• Опція «розмір партії» | 15,30,...,75 банок |</strong><br> → діє як модифікатор оптової знижки !<br>
    Вона має бути <u>однаковою</u> для кожної позиції <em>(різновіду товару)</em> в кошику.<br>
    Кількість банок у кожному товарі <em>(також визначається замовником)</em><br>
    та може <u>відрізнятись</u>, а їх сума <u>має дорівнювати «розміру партії»</u>.<br>
