...
${!same ? `
  <strong>• Опція «розмір партії» [15, 30, ..., 75 банок]<br>→ діє як модифікатор оптової знижки!<br>
→ Ця опція має бути <u>однаковою</u> для кожної позиції у кошику <em>(тобто для кожного різновиду товару)</em>.<br>
Кількість банок для кожного виду товару, <em>яка також визначається замовником</em>,<br>
під час формування асортименту може <u>відрізнятись</u>,<br>
але їхня <strong>загальна кількість</strong> має <u>відповідати єдиному «розміру партії»</u>,<br>
