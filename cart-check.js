...
${!same ? `
  <strong>• Опція «розмір партії» [15, 30, ..., 75 банок]<br>→ діє як модифікатор оптової знижки!</strong><br>
  Ця опція має бути <u>однаковою</u> для кожної позиції у кошику <em>(тобто для кожного різновиду товару)</em>.<br>
  Кількість банок <em>(також визначається замовником)</em> для кожного різновиду товару, та під час комбінування
  асортименту<br> може <u>відрізнятись одна від одної</u>, але їхня загальна кількість має відповідати<br>
  <u>єдиному «розмірові партії»</u>, встановленому для всього замовлення.<br>  
  <strong>→ Будь ласка, дотримуйтесь наступного:</strong><br>
  <ul style="margin-top: 5px;">
    <li>Очистіть кошик повністю</li>
    <li>Сформуйте новий асортимент, дотримуючись вимог до «розміру партії»</li>
  </ul>
` : ''}
