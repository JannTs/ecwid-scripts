...
${!same ? `
  ...
  асортименту може <u>відрізнятись одна від одної</u>, але їхня загальна<br> кількість має відповідати
  <u>єдиному «розмірові партії»</u>,<br> встановленому для <u>всього замовлення</u>.<br>  
