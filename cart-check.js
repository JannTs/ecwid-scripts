...
${!same ? `
  ...
  Кількість банок <em>(також визначається замовником)</em> для кожного різновиду товару<br>
  може <u>відрізнятись одна від одної</u> під час комбінування асортименту,<br>
  але їхня загальна кількість <u>має дорівнювати встановленому «розміру партії»</u>.<br>  
