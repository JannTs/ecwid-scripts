...
${!same ? `
  ...
  Кількість банок <em>(також визначається замовником)</em> для кожного різновиду товару може<br>
  <u>відрізнятись одна від одної</u> під час комбінування асортименту, але їхня загальна кількість<br>
  Має відповідати єдиному «розмірові партії», <u>встановленому для всього замовлення.</u>.<br>  
