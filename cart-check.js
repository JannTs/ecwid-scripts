...
const BULK = {
  ...
  ${!same ? `
    • Оптова ціна залежить від <strong>єдиного</strong> розміру партії, встановленого для кожної позиції у кошику.<br>
    → Тому, будь ласка:
    <ul>
      <li>Повністю очистіть кошик</li>
      <li>Сформуйте нову партію з дотриманням вимог до обсягів замовлення</li>
    </ul>
  ` : ''}
