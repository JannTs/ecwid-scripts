...
const BULK = {
  ...
  ${!same ? `
    • <strong>Опція «розмір партії»</strong> (15...75 банок) → діє як<br>модифікатор оптової знижки!<br>
    Вона має бути <strong>однаковою</strong> для кожної позиції (різновіду) в кошику.<br>
    Кількість банок у кожному товарі <em>також визначається замовником</em><br>
    та може <u>відрізнятись</u>, а їх сума має дорівнювати <strong>«розміру партії»<strong>.<br>
    → <strong>Тому, будь ласка:</strong>
