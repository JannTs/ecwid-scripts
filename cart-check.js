...
${!same ? `
  ...
  Кількість банок <em>(також визначається замовником)</em> для кожного виду товару, та під час комбінування
  асортименту<br> може <u>відрізнятись одна від одної</u>, але їхня загальна кількість має відповідати<br>
  <u>єдиному «розмірові партії»</u>, встановленому для <u>всього замовлення</u>.<br>  
