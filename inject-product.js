...
(function () {
  ...
  function injectCalcButton() {
    ...
    wrap.className = [
      'form-control', 'form-control--button', 'form-control--large',
  ...
  // === Loading state (изменяем текст внутри .form-control__button-text) ===
  ...
  // === Find native Add to Bag (для опционального авто-клика) ===
  ...
  // === Автодобавление на созданном товаре (по желанию) ===
